 ...
 */
public class AdViewPreMovieCsj extends com.rumtel.ad.helper.premovie.view.AdViewPreMovieBase {
    ...
    public void start(String locationId) {
        ...
        try {
            ...
            AdSlot adSlot = new AdSlot.Builder().setCodeId(locationId).setSupportDeepLink(true)
                    .setImageAcceptedSize(point.x, point.y).setAdCount(1).build();
            ...
            TTAdSdk.getAdManager().createAdNative(getContext()).loadFeedAd(adSlot, new TTAdNative.FeedAdListener() {
                ...
                public void onFeedAdLoad(List<TTFeedAd> list) {
                    ...
                    adObject.registerViewForInteraction(mRootView, clickViewList, creativeViewList,
                    ...
                    case TTAdConstant.IMAGE_MODE_VIDEO_VERTICAL:
                        ...
                        // ILFactory.getLoader().load(AdViewPreMovieCsj.super.getContext(), mIvImg0,
                    ...
                    case TTAdConstant.IMAGE_MODE_GROUP_IMG:
                        ...
                        if (imageList != null && imageList.size() > 1 && imageList.get(1) != null
                                && imageList.get(1).isValid()) {
                            mIvImg0.setScaleType(ImageView.ScaleType.CENTER_CROP);
                            ILFactory.getLoader().load(AdViewPreMovieCsj.super.getContext(), mIvImg1,
                                    imageList.get(1).getImageUrl());
                        }
                        if (imageList != null && imageList.size() > 2 && imageList.get(2) != null
                                && imageList.get(2).isValid()) {
                            mIvImg0.setScaleType(ImageView.ScaleType.CENTER_CROP);
                            ILFactory.getLoader().load(AdViewPreMovieCsj.super.getContext(), mIvImg2,
                                    imageList.get(2).getImageUrl());
                        }
                        break;
                    }
