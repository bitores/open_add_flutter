...
public class AdViewPreMovieBaidu extends AdViewPreMovieBase {
    ...
    public void start(String locationId) {
        ...
        BaiduNative baidu = new BaiduNative(super.getContext(), locationId,
                new BaiduNative.BaiduNativeNetworkListener() {
                    ...
                    public void onNativeLoad(List<NativeResponse> arg0) {
                        ...
                        ILFactory.getLoader().load(AdViewPreMovieBaidu.super.getContext(), mIvImg0, mAd.getImageUrl(),
                                new LoaderOptions(), new LoadListener() {
                                    @Override
